...
const MainBody = () => {
  ...
  <div className="w-full md:w-1/3 p-4">
    <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <img src="https://th.bing.com/th/id/OIP.EDmHwD7LeEDfZBubYx3GUQHaEt?rs=1&pid=ImgDetMain" alt="Ethereum" className="w-full h-32 object-cover"/>
      <div className="p-4">
        <h2 className="text-gray-800 font-bold text-xl">Doge Coin</h2>
        <p className="text-gray-600 text-sm">Price: $200</p>
        <p className="text-green-500 text-sm">Change: +1.12%</p>
        <p className="text-gray-600 text-sm">Volume Traded: 123,45,679</p>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/3 p-4">
